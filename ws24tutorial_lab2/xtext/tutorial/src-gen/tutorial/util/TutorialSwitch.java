...
public class TutorialSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case TutorialPackage.CYLINDER_SHAPE: {
			CylinderShape cylinderShape = (CylinderShape) theEObject;
			T result = caseCylinderShape(cylinderShape);
			if (result == null)
				result = caseShape(cylinderShape);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case TutorialPackage.BLOCK_SHAPE: {
			BlockShape blockShape = (BlockShape) theEObject;
			T result = caseBlockShape(blockShape);
			if (result == null)
				result = caseShape(blockShape);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case TutorialPackage.ITEM_CONNECTION: {
			ItemConnection itemConnection = (ItemConnection) theEObject;
			T result = caseItemConnection(itemConnection);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Cylinder Shape</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Cylinder Shape</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseCylinderShape(CylinderShape object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Block Shape</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Block Shape</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseBlockShape(BlockShape object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Item Connection</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Item Connection</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseItemConnection(ItemConnection object) {
		return null;
	}

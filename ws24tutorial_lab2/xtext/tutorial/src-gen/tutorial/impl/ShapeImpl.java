 ...
 * </p>
 * <ul>
 *   <li>{@link tutorial.impl.ShapeImpl#getLength <em>Length</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ShapeImpl extends MinimalEObjectImpl.Container implements Shape {
	...
	protected EClass eStaticClass() {
		return TutorialPackage.Literals.SHAPE;
	}
	...
	public void setLength(double newLength) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TutorialPackage.SHAPE__LENGTH, oldLength, length));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case TutorialPackage.SHAPE__LENGTH:
			return getLength();
		}

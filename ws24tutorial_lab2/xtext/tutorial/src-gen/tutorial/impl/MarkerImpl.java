 ...
 * </p>
 * <ul>
 *   <li>{@link tutorial.impl.MarkerImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MarkerImpl extends MinimalEObjectImpl.Container implements Marker {
	...
	protected EClass eStaticClass() {
		return TutorialPackage.Literals.MARKER;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TutorialPackage.MARKER__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case TutorialPackage.MARKER__NAME:
			return getName();
		}
